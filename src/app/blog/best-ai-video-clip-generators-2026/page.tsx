      ...
      <div className="space-y-5 mb-14">
        <ToolCard
          tool={{
            rank: 1,
            name: "ClipShip",
            tagline: "Desktop app that runs locally on your PC. Paste a YouTube link or import your own file, get AI clip suggestions, face tracking, multi-speaker handling, and word-level captions without cloud upload or usage credits.",
            highlight: true,
            details: [
              { label: "Pricing", value: "Free / $5 monthly / $99 lifetime" },
      ...
      <Section title="Comparison table">
        <ComparisonTable
          ...
          rows={[
            ...
            { feature: "Pricing model", values: ["Monthly or lifetime", "Subscription", "Subscription", "Subscription", "Subscription"] },
      ...
      <Section title="Which one should you choose?">
        <div className="grid sm:grid-cols-2 gap-4">
          <RecommendationCard
            ...
            recommendation="ClipShip. Runs on your PC with no usage credits. Choose $5 monthly founding Pro or $99 lifetime. Best if you care about privacy or process lots of recordings."
            highlighted
          />
          <RecommendationCard
