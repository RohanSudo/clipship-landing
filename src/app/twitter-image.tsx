  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        />
        <svg viewBox="0 0 64 64" width="80" height="80" style={{ marginBottom: 32 }}>
          <defs>
        ...
        <div style={{ fontSize: 64, fontWeight: 700, color: "white", textAlign: "center", lineHeight: 1.1, marginBottom: 16, letterSpacing: "-0.02em" }}>
          Stop editing. Start shipping.
        </div>
        <div style={{ fontSize: 24, color: "#a1a1aa", textAlign: "center", maxWidth: 700, lineHeight: 1.4 }}>
