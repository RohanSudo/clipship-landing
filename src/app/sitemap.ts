...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const updated20260901 = new Date("2026-09-01T00:00:00.000Z");

  return [
    // Main pages
    { url: baseUrl, lastModified: updated20260901, changeFrequency: "weekly", priority: 1.0 },
    { url: `${baseUrl}/changelog`, lastModified: updated20260901, changeFrequency: "monthly", priority: 0.5 },
