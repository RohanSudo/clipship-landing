...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const updated20260922 = new Date("2026-09-22T00:00:00.000Z");

  return [
    // Main pages
    { url: baseUrl, lastModified: updated20260922, changeFrequency: "weekly", priority: 1.0 },
    { url: `${baseUrl}/support`, lastModified: updated20260909, changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/changelog`, lastModified: updated20260922, changeFrequency: "monthly", priority: 0.5 },
    { url: `${baseUrl}/how-clipship-works`, lastModified: updated20260806, changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/mac`, lastModified: updated20260922, changeFrequency: "weekly", priority: 0.95 },
